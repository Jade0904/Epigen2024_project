...
```{r, out.width=c('80%'), fig.align='center', fig.cap=c('Jaccard Index for Dynamic Peaks')}
...
```{r, out.width=c('80%'), fig.align='center', fig.cap=c('Jaccard Index for Non-dynamic Peaks')}
