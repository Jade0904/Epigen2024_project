...
```{r, out.width=c('80%'), fig.align='center', fig.cap=c('Plot Biological Coefficient of Variation')}
# prepare DGE object
...
```{r, out.width=c('80%'), fig.align='center', fig.cap=c('Mean-Difference Plot of JUN expression')}
# plot test results, take JUN as an example
...
```{r, out.width=c('80%'), fig.align='center', fig.cap=c('Numbers of differential expression sites across all ChIP-seq peak sets')}
